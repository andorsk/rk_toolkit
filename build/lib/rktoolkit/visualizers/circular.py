...
from ..models.graph import Node, NodeMask
...
class CircularVisualizer(RKModelVisualizer):
    '''
    Cicular Visualizer  visualizes an R-K Model
    by plotting clusters and measures in a circular
    pattern in 3D space

    It assumes the R-K Model is at least in 3d
    ...
    def _plot_links(self, model: RKModel, mask: NodeMask = None):
        '''
